    ...
    >
      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {AllProjects.map((project: IProjects) => {
          ...
          return (
            <div key={id} className=" rounded-lg p-4 shadow-md">
              <p className="text-xl font-semibold py-2 ">{project_name}</p>
              <div className="w-full h-[150px] 2xl:h-[350px] overflow-hidden rounded-lg">
                <Image
                  src={project_img}
                  width={600}
                  height={250}
